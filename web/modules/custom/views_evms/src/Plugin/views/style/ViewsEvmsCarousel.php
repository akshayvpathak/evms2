...
namespace Drupal\views_evms\Plugin\views\style;
 ...
 *
 * @ViewsStyle(
 *   id = "views_EVMS_carousel",
 *   title = @Translation("EVMS Carousel"),
 *   help = @Translation("Displays rows in a EVMS Carousel."),
 *   theme = "views_evms_carousel",
 *   display_types = {"normal"}
 * )
 */
class ViewsEvmsCarousel extends StylePluginBase {
   /**
